...
> **v0.7.0**: MCP 서버 + 내장 터미널 추가. LLM CLI로 앱 기능을 프로그래밍적으로 제어할 수 있습니다. 커스텀 앱 아이콘 및 브랜딩 적용.
...
### 🤖 MCP 서버 + 내장 터미널
- **MCP (Model Context Protocol) 서버**: LLM CLI(Copilot CLI, Claude CLI 등)가 앱 기능을 도구로 사용 가능
