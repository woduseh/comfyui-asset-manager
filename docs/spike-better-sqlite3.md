...
> 2026-07-04 환경에서 수행한 실험 기록이에요. 버전·성능·파일 크기·테스트 수와 전환 보류 결정은 당시 결과이며 현재 성능이나 최신 버전을 나타내지 않아요. 재검토 조건은 당시 제안으로, 현재 작업을 자동 실행하거나 전환을 금지하는 규칙이 아니에요. 관련 계획은 [2026-07 하드닝 회고](history/2026-07-hardening.md)에 보관돼요.
